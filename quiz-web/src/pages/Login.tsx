        ...
        <div className="max-w-md mx-auto">
                ...
                <div>
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-smartmind-medium hover:text-smartmind-dark focus:outline-none transition-colors duration-200"
                      tabIndex={-1}
                    >
                      {showPassword ? (
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-3 w-3 text-smartmind-dark focus:ring-smartmind-light border-gray-300 rounded transition-all duration-200"
                    />
                    <label htmlFor="remember-me" className="ml-2 block text-smartmind-dark">
                      Remember me
                    </label>
                  </div>
                  <div>
                    <Link to="/forgot-password" className="font-medium text-smartmind-medium hover:text-smartmind-dark transition-colors duration-200">
                      Forgot password?
                    </Link>
                  </div>
                </div>
          ...
          <div className={`text-center ${formInView ? 'animate-element-pop-up [animation-delay:0.8s]' : 'opacity-0 translate-y-8'}`}>
            <p className="text-sm text-smartmind-dark">
              ...
              <Link to="/register" className="font-medium text-smartmind-medium hover:text-smartmind-dark transition-colors duration-200">
                Sign up
              </Link>
            </p>
          </div>
